...
import { Mail, Phone, User, Gift, Utensils } from 'lucide-react';
...
function App() {
  ...
  const handleSubmit = () => {
    ...
    setTimeout(() => {
      ...
      setShowSuccess(true);
      // Reset form data but keep success message
    ...
    <>
      <div className="min-h-screen bg-gradient-to-br from-zinc-950 via-zinc-900 to-black flex items-center justify-center p-4 px-4">
        <div className="w-full max-w-md">
          ...
          {/* Card con glassmorphism + inner shadow */}
              ...
              {showSuccess ? (
                <div className="text-center py-12 animate-in fade-in zoom-in duration-700">
                  ...
                  <p className="text-orange-200">
                    Ya puedes revisar tu correo electronico para ver tu ticket ganador!
                  </p>
                </div>
              ) : (
                <div className="space-y-7">
                  ...
                  {/* Botón premium con degradado animado */}
                  <button
